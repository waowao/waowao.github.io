...
3. 计算每日所需总热量: 按理想体重计算
   轻体力劳动者：每日需要的热量标准：每千克理想体重20～30kcal
...
根据食品交换份计算每餐次营养素分配量（制订食谱），有些食物是可以基本固定的，
烹调植物油 10g（1 份），牛奶 150g（1份）或豆浆 200ml（1份），蔬菜500g 1份，它们每日所需的量及提供的热量基本相同。在总量中减去这些食物所供给的营养素。
食谱内容可计算如下：
（1）	碳水化合物供给量：
乳类（或豆浆）1 份、蔬菜 1 份，供给的碳水化合物为 25g，全日需碳水化合物 195g，
不足部分（195－25＝170g）由谷类补足，每份谷类含碳水化合物 20g，所以需要谷类：170÷20＝8.5份。
（2） 蛋白质供给量：
...
每天的食物用量为：
乳类（或豆浆）： 1 交换份 150g（或 200ml）
蔬菜类： 1 交换份 500g
谷类： 8.5 交换份 210g
瘦肉类： 2.5 交换份 125g
油脂类： 2 交换份 20g
最后，根据食品交换份可在不同种类食物品种之间作等值交换，达到多样化的目的。
